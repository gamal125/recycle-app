                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Center(child: Text(' نبذة عن الموقع ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: MediaQuery.of(context).size.width*0.02,),)),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(5.0),
                      child: Text("Recycle Rewards",
                        textAlign: TextAlign.right,style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold,fontSize: MediaQuery.of(context).size.width*0.02,),),
                    ),
                    const Padding(
